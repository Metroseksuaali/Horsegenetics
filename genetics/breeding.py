...
DEPRECATED: This module only handles 9 of 17 genes.
Use genetics.gene_registry.GeneRegistry.breed() for full 17-gene breeding,
or genetics.horse.Horse.breed() for the high-level API.
