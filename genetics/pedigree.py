...
class PedigreeTree:
    ...
    def add_breeding(
        ...
        """
        # Generate IDs from genotype strings (unique identifier)
        sire_id = str(hash(sire.genotype_string))
        dam_id = str(hash(dam.genotype_string))
        foal_id = str(hash(foal.genotype_string))
