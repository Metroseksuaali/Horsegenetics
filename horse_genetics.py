...
class HorseGeneticGenerator:
    ...
    def determine_base_color(self, extension, agouti):
        ...
        # Extension e/e = chestnut (no black pigment)
        if extension == ('e', 'e'):
            return 'chestnut'
        # With Extension E, Agouti determines black distribution
        if agouti[0] == 'A' or agouti[1] == 'A':
            return 'bay'
        return 'black'
...
def main():
    ...
    print("=" * 60)
    print("\nThis simulator models 17 genetic traits:")
    ...
    print(" 10. Roan (Rn/n) - Intermixed white hairs")
    print(" 11. Tobiano (To/n) - White spotting pattern")
    print(" 12. Frame Overo (O/n) - Frame white pattern")
    print(" 13. Sabino (Sb/n) - Sabino markings")
    print(" 14. Dominant White (W/n) - White coat")
    print(" 15. Splash White (Spl/n) - Splash pattern")
    print(" 16. Leopard Complex (Lp/lp) - Appaloosa spotting")
    print(" 17. PATN1 (PATN1/n) - Pattern modifier for Leopard")
